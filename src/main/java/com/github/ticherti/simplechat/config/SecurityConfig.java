...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.DELETE, "rest/rooms/{roomId}/messages").hasAuthority(Permission.DELETE_MESSAGE.name())
                .antMatchers(HttpMethod.PUT, "/rest/rooms/{roomId}/messages").denyAll()
